...
test('getCurrentFiscalYear', () => {
  ...
  expect(getCurrentFiscalYear()).toEqual(2022)
...
test('getAllFiscalYearsInReverse', () => {
  ...
  expect(getAllFiscalYearsInReverse()).toEqual([2022, 2021, 2020])

  vi.setSystemTime(new Date('2023-07-01'))
  expect(getAllFiscalYearsInReverse()).toEqual([2023, 2022, 2021, 2020])

  vi.setSystemTime(new Date('2025-06-30'))
  expect(getAllFiscalYearsInReverse()).toEqual([2024, 2023, 2022, 2021, 2020])
