...
import { BankTransactionType, TransactionsResponse } from './api/transactions'
...
const types = ['regular', 'savings', 'tax'] as const

const typeToLabel: { [key in BankTransactionType]: string } = {
          ...
          types.map((type) => (
            <div key={type}>
              ...
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody>
                  {transactions.data[type].map((transaction) => (
                    <tr
